<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.favoriting', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/favoriting') ? 'active' : '' }}">Favorites <span class="badge badge-secondary">{{ $count_favorite}}</span></a></li>
